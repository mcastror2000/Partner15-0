...
import Header from "../components/Header"; // Usar el Header común
import Button from "../components/Button"; // Usar botones genéricos
...
const ScheduleMatches = () => {
  ...
  const handleSaveMatch = async (index) => {
    ...
    console.log("matchDetails antes de guardar:", matchDetails);
    console.log("Datos a guardar:", updatedMatch);
    console.log("ID del partido a actualizar:", match.id);
              ...
              <div>
                ...
                {match.Ganador ? (
                  ...
                  <Button
                    ...
                    className={`primary-button ${match.Ganador ? "btn-disabled" : ""}`}
